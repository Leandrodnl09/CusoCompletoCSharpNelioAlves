...
Print("NAMES STARTED WITH 'C' AND ANANYMOUS OBJECT: ", r3);
...
var r7 = products.Where(p => p.Price > 3000.0).First(); // Ecessão;
Console.WriteLine("First test 2: " + r7);

var r8 = products.Where(p => p.Id == 3).SingleOrDefault();
Console.WriteLine("Silgle or default test 1: " + r8);

var r9 = products.Where(p => p.Id == 30).SingleOrDefault();
Console.WriteLine("Silgle or default test 2: " + r9);
...
var r15 = products.Where(p => p.Category.Id == 5).Select(p => p.Price).Aggregate(x, y => x + y);
Console.WriteLine("Category 5 Aggregate price: " + r15);
...
Print("TIER 1 AND PRICE < 900.00: ", r17);
